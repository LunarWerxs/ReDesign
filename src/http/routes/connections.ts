...
// PUT /api/settings/sync body handler. Pulled out of register() so its branching (enable /
// disable / appearance-only update) scores against this small function instead of register's.
async function putSettingsSync(c: Context): Promise<Response> {
...
export function register(app: Hono, _deps: Deps): void {
  ...
  app.put("/api/settings/sync", requireSameOrigin(), putSettingsSync);
